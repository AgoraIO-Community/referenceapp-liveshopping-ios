...
|-------------|-------------|----------|----------|
| Find live streams | Users must be able to view live streams of products being sold in real-time. | P0 | The mechanism for showing users all the live streams will be similar to tiktok or the photos app, using [SnapToScroll](https://github.com/swiftui-library/hstack-snap-to-scroll). |
| Real-time purchasing or bidding | Users must be able to place bids or purchase products in real-time during live streams. | P0 | Achieved using RTM, having users see the current price and/or the next available bidding price. |
...
| Product details | Users must be able to view more detailed information about each product, including images, descriptions, and pricing. | P0 | Limited detail will be essential, more information will be available by showing the product as a card while a sale or bidding is in progress. |
...
| Shopify Backend | Create a store on Shopify, and link it to the application. [Guide](https://youtu.be/u-Qfdn44rB4) | P1 | Will need writing up and steps documented |
